...
def create_option_thumbnails(
    ...
    positions: list[tuple[int, int]] = [
        (0, 0),
        ((canvas_size - asset.width) // 2, 0),
        (canvas_size - asset.width, 0),

        (0, (canvas_size - asset.height) // 2),
        ((canvas_size - asset.width) // 2, (canvas_size - asset.height) // 2),
        (canvas_size - asset.width, (canvas_size - asset.height) // 2),

        (0, canvas_size - asset.height),
        ((canvas_size - asset.width) // 2, canvas_size - asset.height),
        (canvas_size - asset.width, canvas_size - asset.height)
    ]
